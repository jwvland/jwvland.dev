...
<section class="section2">
  ...
  <div class="container">
    <div class="bContainer">
      <h2 class="rsABlock" data-move-effect="bottom">Welcome to <strong>roofers,</strong> Roofing Services</h2>
...
roofing Contractor</h1>
  ...
  <div class="container">
    <div class="bContainer">
      ...
      Aliq erat volutpat ut <strong>Augue</strong> dui,roofers
      </h2>
      <h1 class="rsABlock" data-move-effect="left">Residential, Shingle Replacement and<br> Roof Leak Repair 
        </h1>
          <span class="rsABlock" data-move-effect="bottom">
             <a href="#" class="red-button  btn-4 btn-4c">
             <span>read more</span>
  ...
  <div class="container">
    <div class="bContainer">
      ...
      <h1 class="rsABlock" data-move-effect="left">Roof Maintenance, Commercial and<br> Industrial 
      Waterproofing</h1>
          <span class="rsABlock" data-move-effect="bottom">
             <a href="#" class="red-button  btn-4 btn-4c">
             <span>read more</span>
  ...
  <div class="item slide4">
    ...
    <div class="container">
      ...
      <h1 class="rsABlock" data-move-effect="left">Roof Replacement , Roof Inspections <br class="hidden-xs"> Roof Prevetative </h1>
          <span class="rsABlock" data-move-effect="bottom">
             <a href="#" class="red-button  btn-4 btn-4c">
             <span>read more</span>
             </a></span>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                <h1>Welcome to Rooffers,Roofing Company</h1>
                <hr class="center">
...
varius at lacinia dui sed, ultricies sapien.
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="news-detail clearfix jw-animate-gen noOpacity" data-gen-offset="85%" data-gen="fadeInRight">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                <h3>Premier Commercial Roofing Company</h3>
                <p>
                Curabitur ullamcorper, felis bibendum rutrum consectetur, justo...
                </p>
                 <a href="news.html" class="red-button  btn-4 btn-4c">
    ...
    <div class="row text-center price-plan">
      <div class="col-md-3 col-sm-6 jw-animate-gen noOpacity" data-gen-offset="85%" data-gen="fadeInUp">
        <div class="panel panel-default standard-membership">
          ...
          <a class="red-button btn-4 btn-4c" href="#">
            <span>Read More</span>
          </a>
        </div>
      </div>
